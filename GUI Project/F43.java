...
public class F43 extends JFrame  implements ActionListener
{
	...
	public F43()
	{
		...
		l1 = new JLabel("See Ammount of Each Product in Stock in kg");
		...
		l2 = new JLabel("Product no  Product Type   Previous    Buying     Selling     Date             Current ");
        ...
        l11 = new JLabel("Amount     Amount     Amount                      Amount ");
		...
		l4 = new JLabel("01          Tomato          41           24        26         12-08-20   39 ");
		...
		l3 = new JLabel("02          Banana          41           24        26         12-08-20   39 ");
		...
		l5 = new JLabel("03          Onion            41           24        26         12-08-20   39 ");
		...
		l6 = new JLabel("04          Eggplant       41           24        26         12-08-20   39 ");
		...
		l7 = new JLabel("04          Fish               30           12        32         12-08-20   10 ");
		...
		l8 = new JLabel("05          rice               300         120      320        13-08-20   120 ");
		...
		l9 = new JLabel("06          Suger            50           60        60         13-09-20   50 ");
		...
		l10 = new JLabel("07          Pulses           40           26        26         12-08-20   40 ");
